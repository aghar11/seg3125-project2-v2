                        ...
                        <Col>
                            <Card style={{ width: '35rem' }}>
                                ...
                                <Card.Body>
                                    ...
                                    <Button variant="dark" className='mx-auto d-block' href="/horizonView">{t('learnMore')}</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col>
                            <Card style={{ width: '35rem' }}>
                                ...
                                <Card.Body>
                                    ...
                                    <Button variant="dark" className='mx-auto d-block' href="/soaringHeights">{t('learnMore')}</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
